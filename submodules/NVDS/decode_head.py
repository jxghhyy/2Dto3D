...
# ---- mmcv.cnn.normal_init 纯 PyTorch 替代 ----
def normal_init(module, mean=0, std=1, bias=0):
    """Initialize module weights with normal distribution (mmcv 兼容)."""
...
from torch.nn.functional import interpolate as _resize

def resize(input, size=None, scale_factor=None, mode='nearest', align_corners=None):
    """mmseg.ops.resize 纯 PyTorch 替代"""
    return _resize(input, size=size, scale_factor=scale_factor, mode=mode, align_corners=align_corners)
